...
/**
 * El directorio de proveedores, compartido por la clínica y el petshop.
 *
 * `proveedores` (0030) es de la clínica: `proveedores_lectura` es
 * `clinica_id = auth_clinica_id()`. Una veterinaria también le compra a
 * laboratorios y distribuidores, y hasta ahora no tenía dónde anotarlo.
 *
 * Ver [PanelLotes](./PanelLotes.tsx) para el porqué de `conCabecera`.
 */
export function PanelProveedores({ conCabecera = true }: { conCabecera?: boolean }) {
