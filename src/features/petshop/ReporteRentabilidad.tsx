...
/**
 * El informe de rentabilidad del negocio: ventas, costo de mercadería vendida
 * (COGS) y margen, con desglose por categoría retail.
 *
 * Lo pintan **dos** pantallas: `/petshop/reportes`, dentro del panel, y
 * `/metricas` cuando el negocio es de retail. Vive aquí para que no diverjan.
 *
 * Antes `MetricasPage` le enseñaba a un petshop «Nuevos Pacientes» y «Total
 * Pacientes», y su enlace de stock bajo apuntaba al inventario clínico — una
 * ruta que un petshop ya no tiene.
 *
 * La cabecera es un prop porque cada sitio lo llama de otra forma: «Reportes»
 * dentro del panel, «Métricas» en el menú lateral.
 */
interface Props {
  titulo: string
  subtitulo: string
...
export function ReporteRentabilidad({ titulo, subtitulo }: Props) {
